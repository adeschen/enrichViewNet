# Validate arguments passed to validateCreateEnrichMapMultiComplex() function

Validate the arguments passed to validateCreateEnrichMapMultiComplex()
...
- showCategory:
  ...
  will be displayed. If `NULL`, all terms will be displayed.
