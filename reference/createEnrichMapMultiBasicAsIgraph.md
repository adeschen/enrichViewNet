...
output is an enrichment map in igraph format.
...
- similarityCutOff:
  ...
  similarity between two terms, calculated using the Jaccard
  coefficient, to have an edge linking the terms. Default: `0.20`.
